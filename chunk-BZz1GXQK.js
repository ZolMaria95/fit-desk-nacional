import {D,Y as Yp,f as ee,e as Wt$1,aK as G,h as we,j as WL,F as Ft,G as G$1,l as Ly,aL as ih,O as OE,aM as W$1,aN as zt,aO as mt$1,i as ii,a as iI,Q as QI,w as wc,g as gp,B as lI,r as lp,aj as tp,aP as _I,k as ky,s as sI,d as cp,I as uI,t as Dp,C as CI,u as O,$ as $e$1,aQ as $,aR as B,H as Ht$1,x as jt$1,N as Nt$1,y as zt$1,V as Vt,ag as mI,P as Pp,ah as Yl,X as XI,ai as Kl,W as Wv,A as Ap,b as Op,z as zv,a3 as Cp,ae as ap,M as Mc,K as LE,R as Cl,a7 as vt,U as mr$1,av as QL,aS as Y,aA as Is,aq as N$1,ar as te,aT as nn,as as $e$2,au as me,aE as Qh,aw as Yh,aU as ot,a9 as Xt,aG as Rh,ak as VE,aV as YL,ad as iD,an as Se,aW as Ii,aX as xn,aY as M,aZ as k,ay as tn,a_ as Jh,a$ as Zh,b0 as im,b1 as KL,b2 as gh,T as qr,ax as Hr,a4 as vp,a5 as TI,a6 as bI,am as Ir$1,aB as ct,b3 as q,b4 as sh,b5 as Up,b6 as nh,b7 as J,a0 as II,a1 as DI,az as Ep,b8 as Ou,b9 as BL,ba as cn$1,_ as tr$2,bb as bh,bc as ht,bd as pp,a2 as FI,aa as Tm,ab as Xf,aC as Wo$1,be as en$1,bf as Tc,bg as bc,bh as m,bi as lu,bj as uu,bk as ao$1,v as vI,bl as cI,bm as gr$1,aD as T$1,bn as dr$1,ao as jv,bo as U$1,bp as kh,bq as Zt,br as P$1,bs as Pe,bt as Le,af as bp,bu as uh,bv as kp,bw as Fp,bx as eD,by as tD,bz as aD,aJ as Zd}from'./main-GFR7AINI.js';import {_,I}from'./chunk-BiT4i0j-.js';import {v as vi$1}from'./chunk-CydupyBa.js';import {M as Mr$1,L as Ln,c as cn,I as Ir,p as pt,R as Rr,V as Vr,O as Or,T as Tr,P as Pr,x as xr$1,k as kr$1,w as wr$1,D as Dr$1,E as Er,B as Br,m as mt,A as Ar,F as Fr,S as Sr$1,e as en,J as Ja$1,a as Ss,b as As,d as Tn,t as tr$1}from'./chunk-CmYJQc0Z.js';import {L as Lt,P,G as G$2,N as Nt}from'./chunk-ClvzjDes.js';import {c}from'./chunk-DYSa0MxQ.js';import'./chunk-BV1UTPKk.js';import'./chunk-CHN_1adC.js';import {d,f}from'./chunk-DI90pxVe.js';import {T}from'./chunk-BDcgwmd9.js';import {K}from'./chunk-BAasWF8O.js';import {Q as Qt}from'./chunk-5K8WC06U.js';import {B as Bt,W as Wt$2,b}from'./chunk-CXs-gVGz.js';import {y as yt,w as wt}from'./chunk-BCY5jSWx.js';import {h as ha$1,p as pa$1,G as Gi,f as fe,B as Bn,d as de,c as ce,_ as _o,A as Ar$1,F as Fr$1,X as Xo$1,a as an,O as Oi,$ as $o$1,e as pi$1,R as Ri,g as gi$1,i as Yt,s as st}from'./chunk-B2eTXtnZ.js';import {N}from'./chunk-zDHWh73r.js';function di(a){let i=a.cloneNode(true),e=i.querySelectorAll("[id]"),t=a.nodeName.toLowerCase();i.removeAttribute("id");for(let n=0;n<e.length;n++)e[n].removeAttribute("id");return t==="canvas"?Un(a,i):(t==="input"||t==="select"||t==="textarea")&&qn(a,i),Gn("canvas",a,i,Un),Gn("input, textarea, select",a,i,qn),i}function Gn(a,i,e,t){let n=i.querySelectorAll(a);if(n.length){let o=e.querySelectorAll(a);for(let r=0;r<n.length;r++)t(n[r],o[r]);}}var Aa=0;function qn(a,i){i.type!=="file"&&(i.value=a.value),i.type==="radio"&&i.name&&(i.name=`mat-clone-${i.name}-${Aa++}`);}function Un(a,i){let e=i.getContext("2d");if(e)try{e.drawImage(a,0,0);}catch{}}function fi(a){let i=a.getBoundingClientRect();return {top:i.top,right:i.right,bottom:i.bottom,left:i.left,width:i.width,height:i.height,x:i.x,y:i.y}}function hi(a,i,e){let{top:t,bottom:n,left:o,right:r}=a;return e>=t&&e<=n&&i>=o&&i<=r}function Ba(a,i){let e=i.left<a.left,t=i.left+i.width>a.right,n=i.top<a.top,o=i.top+i.height>a.bottom;return e||t||n||o}function Ue(a,i,e){a.top+=i,a.bottom=a.top+a.height,a.left+=e,a.right=a.left+a.width;}function jn(a,i,e,t){let{top:n,right:o,bottom:r,left:h,width:u,height:_}=a,x=u*i,y=_*i;return t>n-y&&t<r+y&&e>h-x&&e<o+x}var Ht=class{_document;positions=new Map;constructor(i){this._document=i;}clear(){this.positions.clear();}cache(i){this.clear(),this.positions.set(this._document,{scrollPosition:this.getViewportScrollPosition()}),i.forEach(e=>{this.positions.set(e,{scrollPosition:{top:e.scrollTop,left:e.scrollLeft},clientRect:fi(e)});});}handleScroll(i){let e=P$1(i),t=this.positions.get(e);if(!t)return null;let n=t.scrollPosition,o,r;if(e===this._document){let _=this.getViewportScrollPosition();o=_.top,r=_.left;}else o=e.scrollTop,r=e.scrollLeft;let h=n.top-o,u=n.left-r;return this.positions.forEach((_,x)=>{_.clientRect&&e!==x&&e.contains(x)&&Ue(_.clientRect,h,u);}),n.top=o,n.left=r,{top:h,left:u}}getViewportScrollPosition(){return {top:window.scrollY,left:window.scrollX}}};function na(a,i){let e=a.rootNodes;if(e.length===1&&e[0].nodeType===i.ELEMENT_NODE)return e[0];let t=i.createElement("div");return e.forEach(n=>t.appendChild(n)),t}function bi(a,i,e){for(let t in i)if(i.hasOwnProperty(t)){let n=i[t];n?a.setProperty(t,n,e?.has(t)?"important":""):a.removeProperty(t);}return a}function Fe(a,i){let e=i?"":"none";bi(a.style,{"touch-action":i?"":"none","-webkit-user-drag":i?"":"none","-webkit-tap-highlight-color":i?"":"transparent","user-select":e,"-ms-user-select":e,"-webkit-user-select":e,"-moz-user-select":e});}function Wn(a,i,e){bi(a.style,{position:i?"":"fixed",top:i?"":"0",opacity:i?"":"0",left:i?"":"-999em"},e);}function Gt(a,i){return i&&i!="none"?a+" "+i:a}function $n(a,i){a.style.width=`${i.width}px`,a.style.height=`${i.height}px`,a.style.transform=je(i.left,i.top);}function je(a,i){return `translate3d(${Math.round(a)}px, ${Math.round(i)}px, 0)`}var Ge={capture:true},ci={passive:false,capture:true},Na=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=OE({type:a,selectors:[["ng-component"]],hostAttrs:["cdk-drag-resets-container",""],decls:0,vars:0,template:function(t,n){},styles:[`@layer cdk-resets {
  .cdk-drag-preview {
    background: none;
    border: none;
    padding: 0;
