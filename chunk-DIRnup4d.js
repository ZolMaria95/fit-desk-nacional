...
`],encapsulation:2})}return l})(),gt=(()=>{class l{static \u0275fac=function(t){return new(t||l)};static \u0275mod=FE({type:l});static \u0275inj=Sl({imports:[We,qr]})}return l})();var bi=()=>({standalone:true}),Cn=(l,a)=>a.id;function ui(l,a){if(l&1&&(si$1(0,"mat-option",4),ZI(1),Cc()),l&2){let e=a.$implicit;lp("value",e.id),Oy(),kp(e.nombre);}}function hi(l,a){if(l&1&&(si$1(0,"mat-option",4),ZI(1),Cc()),l&2){let e=a.$implicit;lp("value",e.id),Oy(),kp(e.name);}}function _i(l,a){if(l&1){let e=yI();si$1(0,"mat-slide-toggle",15),Lp("ngModelChange",function(n){Xl(e);let i=EI();return eD(i.form.activo,n)||(i.form.activo=n),eu(n)}),ZI(1),Cc(),Gv();}if(l&2){let e=EI();Pp("ngModel",e.form.activo),Qv(),Oy(),xc(" ",e.form.activo?"Activo":"Inactivo"," ");}}var je=class l{api=D(u);hd=D(J);snack=D(Qt);ref=D(O);data=D($e);regionales=this.data.regionales;guardando=Ft(false);editando=!!this.data.equipo;hdUsers=this.hd.hdUsers;hdBuscar=Ft("");hdFiltrados=K(()=>{let a=this.hdBuscar().trim().toLowerCase(),e=this.hdUsers();return a?e.filter(t=>t.name.toLowerCase().includes(a)||String(t.id).toLowerCase().includes(a)):e});form={regionalId:null,codigo:"",nombre:"",responsableHid:null,activo:true};constructor(){this.hd.getHdUsers();let a=this.data.equipo;a&&(this.form={regionalId:a.regionalId,codigo:a.codigo,nombre:a.nombre,responsableHid:a.responsableHelpdeskUserId??null,activo:a.activo});}async crear(){let{regionalId:a,codigo:e,nombre:t,responsableHid:n,activo:i}=this.form;if(!a||!e.trim()||!t.trim()){this.snack.open("Complet\xE1 regional, c\xF3digo y nombre.","OK",{duration:3500});return}this.guardando.set(true);try{let p={};n&&(p.responsableHelpdeskUserId=String(n),p.responsableNombre=this.hdUsers().find(P=>String(P.id)===String(n))?.name);let _;this.editando?_=await this.api.actualizarEquipo(this.data.equipo.id,B({regionalId:a,nombre:t.trim(),activo:i},p)):_=await this.api.crearEquipo(B({regionalId:a,codigo:e.trim().toUpperCase(),nombre:t.trim()},p)),this.ref.close(_);}catch(p){let _=p?.error?.error,P=this.editando?"editar":"crear";this.snack.open(_?`No se pudo ${P} el equipo. ${_}`:`No se pudo ${P} el equipo.`,"OK",{duration:4e3});}finally{this.guardando.set(false);}}cancelar(){this.ref.close();}static \u0275fac=function(e){return new(e||l)};static \u0275cmp=PE({type:l,selectors:[["app-crear-equipo-dialog"]],decls:36,vars:14,consts:[["mat-dialog-title",""],[1,"dialog-form"],["appearance","outline",1,"full"],["name","er",3,"ngModelChange","ngModel"],[3,"value"],["appearance","outline"],["matInput","","name","ec","placeholder","QUITO",3,"ngModelChange","ngModel","disabled"],["matInput","","name","en","placeholder","Equipo Quito",3,"ngModelChange","ngModel"],["name","resp",3,"ngModelChange","ngModel"],[1,"opt-buscar-wrap",3,"click"],["placeholder","Buscar empleado\u2026",1,"opt-buscar",3,"ngModelChange","click","keydown","ngModel","ngModelOptions"],["name","ea",1,"full",3,"ngModel"],["align","end"],["mat-button","",3,"click"],["mat-flat-button","","color","primary",3,"click","disabled"],["name","ea",1,"full",3,"ngModelChange","ngModel"]],template:function(e,t){e&1&&(si$1(0,"h2",0),ZI(1),Cc(),si$1(2,"mat-dialog-content")(3,"div",1)(4,"mat-form-field",2)(5,"mat-label"),ZI(6,"Regional"),Cc(),si$1(7,"mat-select",3),Lp("ngModelChange",function(i){return eD(t.form.regionalId,i)||(t.form.regionalId=i),i}),uI(8,ui,2,2,"mat-option",4,Cn),Cc(),Gv(),Cc(),si$1(10,"mat-form-field",5)(11,"mat-label"),ZI(12,"C\xF3digo"),Cc(),si$1(13,"input",6),Lp("ngModelChange",function(i){return eD(t.form.codigo,i)||(t.form.codigo=i),i}),Cc(),Gv(),Cc(),si$1(14,"mat-form-field",5)(15,"mat-label"),ZI(16,"Nombre"),Cc(),si$1(17,"input",7),Lp("ngModelChange",function(i){return eD(t.form.nombre,i)||(t.form.nombre=i),i}),Cc(),Gv(),Cc(),si$1(18,"mat-form-field",2)(19,"mat-label"),ZI(20,"Responsable de equipo (opcional, del HelpDesk)"),Cc(),si$1(21,"mat-select",8),Lp("ngModelChange",function(i){return eD(t.form.responsableHid,i)||(t.form.responsableHid=i),i}),si$1(22,"div",9),mp("click",function(i){return i.stopPropagation()}),si$1(23,"input",10),mp("ngModelChange",function(i){return t.hdBuscar.set(i)})("click",function(i){return i.stopPropagation()})("keydown",function(i){return i.stopPropagation()}),Cc(),Gv(),Cc(),si$1(24,"mat-option",4),ZI(25,"\u2014 sin responsable \u2014"),Cc(),uI(26,hi,2,2,"mat-option",4,Cn),Cc(),Gv(),Cc(),sI(28,_i,2,2,"mat-slide-toggle",11),Cc()(),si$1(29,"mat-dialog-actions",12)(30,"button",13),mp("click",function(){return t.cancelar()}),ZI(31,"Cancelar"),Cc(),si$1(32,"button",14),mp("click",function(){return t.crear()}),si$1(33,"mat-icon"),ZI(34),Cc(),ZI(35),Cc()()),e&2&&(Oy(),kp(t.editando?"Editar equipo":"Nuevo equipo"),Oy(6),Pp("ngModel",t.form.regionalId),Qv(),Oy(),dI(t.regionales),Oy(5),Pp("ngModel",t.form.codigo),lp("disabled",t.editando),Qv(),Oy(4),Pp("ngModel",t.form.nombre),Qv(),Oy(4),Pp("ngModel",t.form.responsableHid),Qv(),Oy(2),lp("ngModel",t.hdBuscar())("ngModelOptions",aD(13,bi)),Qv(),Oy(),lp("value",null),Oy(2),dI(t.hdFiltrados()),Oy(2),aI(t.editando?28:-1),Oy(4),lp("disabled",t.guardando()),Oy(2),kp(t.editando?"save":"add"),Oy(),xc(" ",t.editando?"Guardar":"Crear equipo"," "));},dependencies:[ta,ie,Xn,bn$1,Ht,Nt,zt,Vt,va,ga,yt,wt,de,nt,oe,nn,tn,Ft$1,Rt,J$1,gt,We],styles:[".admin[_ngcontent-%COMP%]{padding:16px;max-width:1100px;margin:0 auto}.admin-head[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;gap:12px}.admin-head[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%]{margin:0;font-size:1.4rem}.tab-body[_ngcontent-%COMP%]{padding:16px 4px}.tab-actions[_ngcontent-%COMP%]{display:flex;justify-content:flex-end;align-items:center;gap:12px;margin-bottom:12px}.buscador[_ngcontent-%COMP%]{display:flex;align-items:center;gap:6px;margin-right:auto;padding:4px 10px;border:1px solid rgba(0,0,0,.18);border-radius:20px;background:#fff;min-width:260px}.buscador[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{color:#0006;font-size:20px;width:20px;height:20px}.buscador[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]{flex:1;border:none;outline:none;background:transparent;font-size:14px}.crear[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;align-items:center;gap:12px;margin-bottom:12px}.crear[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]{width:180px}.crear[_ngcontent-%COMP%]   mat-form-field.ancho[_ngcontent-%COMP%]{width:300px}.crear[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{height:48px}.opt-buscar[_ngcontent-%COMP%]{width:100%;box-sizing:border-box;border:none;outline:none;padding:6px 4px;font:inherit;background:transparent}.acciones[_ngcontent-%COMP%]{width:48px;text-align:center}.acciones.acciones-2[_ngcontent-%COMP%]{width:96px;white-space:nowrap}.rolchips[_ngcontent-%COMP%]{display:inline-flex;flex-wrap:wrap;gap:6px}.chip[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:4px;padding:2px 4px 2px 8px;border-radius:999px;background:#3f51b51f;color:#303f9f;font-size:.78rem;white-space:nowrap}.chip[_ngcontent-%COMP%]   .chip-txt[_ngcontent-%COMP%]{cursor:pointer}.chip[_ngcontent-%COMP%]   .chip-txt[_ngcontent-%COMP%]:hover{text-decoration:underline}.chip[_ngcontent-%COMP%]   .chip-x[_ngcontent-%COMP%]{border:none;background:transparent;color:inherit;cursor:pointer;font-size:1rem;line-height:1;padding:0 2px;border-radius:999px;opacity:.6}.chip[_ngcontent-%COMP%]   .chip-x[_ngcontent-%COMP%]:hover{opacity:1;background:#0000001a}.muted[_ngcontent-%COMP%]{color:#0006;font-style:italic}.dialog-form[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:4px 12px;padding-top:8px;box-sizing:border-box}.dialog-form[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]{flex:1 1 200px;min-width:0}.dialog-form[_ngcontent-%COMP%]   mat-form-field.full[_ngcontent-%COMP%]{flex:1 1 100%}mat-dialog-content[_ngcontent-%COMP%]{overflow-x:hidden}.color-field[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:6px}.color-field.full[_ngcontent-%COMP%]{width:100%}.color-label[_ngcontent-%COMP%]{font-size:.75rem;color:#0009}.swatches[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:8px}.swatch[_ngcontent-%COMP%]{width:30px;height:30px;border-radius:6px;border:2px solid rgba(0,0,0,.12);cursor:pointer;padding:0;position:relative;display:inline-flex;align-items:center;justify-content:center}.swatch.sel[_ngcontent-%COMP%]{border-color:#000000d9;box-shadow:0 0 0 2px #fff inset}.swatch[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:18px;width:18px;height:18px;color:#0000008c}.swatch.custom[_ngcontent-%COMP%]{overflow:hidden;background:repeating-conic-gradient(#eee 0% 25%,#fff 0% 50%) 50%/12px 12px}.swatch.custom[_ngcontent-%COMP%]   input[type=color][_ngcontent-%COMP%]{position:absolute;inset:0;opacity:0;cursor:pointer;border:none;padding:0}.swatch.clear[_ngcontent-%COMP%]{background:#fff}.grid[_ngcontent-%COMP%]{width:100%;border-collapse:collapse;font-size:.9rem}.grid[_ngcontent-%COMP%]   th[_ngcontent-%COMP%], .grid[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{text-align:left;padding:8px 12px;border-bottom:1px solid rgba(0,0,0,.08)}.grid[_ngcontent-%COMP%]   th[_ngcontent-%COMP%]{font-weight:600;color:#0009;white-space:nowrap}.grid[_ngcontent-%COMP%]   th.sortable[_ngcontent-%COMP%]{cursor:pointer;-webkit-user-select:none;user-select:none}.grid[_ngcontent-%COMP%]   th.sortable[_ngcontent-%COMP%]:hover{color:#000000d9}.grid[_ngcontent-%COMP%]   tbody[_ngcontent-%COMP%]   tr[_ngcontent-%COMP%]:hover{background:#00000008}.grid[_ngcontent-%COMP%]   tbody[_ngcontent-%COMP%]   tr.fila-inactiva[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{color:#00000061;font-style:italic}"]})};function fi(l,a){if(l&1){let e=yI();si$1(0,"mat-slide-toggle",9),Lp("ngModelChange",function(n){Xl(e);let i=EI();return eD(i.form.activo,n)||(i.form.activo=n),eu(n)}),ZI(1,"Activa"),Cc(),Gv();}if(l&2){let e=EI();Pp("ngModel",e.form.activo),Qv();}}var Qe=class l{api=D(u);snack=D(Qt);ref=D(O);data=D($e)??{};editando=!!this.data.regional;guardando=Ft(false);form={codigo:"",nombre:"",activo:true};constructor(){let a=this.data.regional;a&&(this.form={codigo:a.codigo,nombre:a.nombre,activo:a.activo});}async crear(){let a=this.form.codigo.trim(),e=this.form.nombre.trim();if(!a||!e){this.snack.open("Complet\xE1 c\xF3digo y nombre.","OK",{duration:3500});return}this.guardando.set(true);try{let t=this.editando?await this.api.actualizarRegional(this.data.regional.id,{codigo:a.toUpperCase(),nombre:e,activo:this.form.activo}):await this.api.crearRegional({codigo:a.toUpperCase(),nombre:e});this.ref.close(t);}catch(t){let n=t?.error?.error,i=this.editando?"editar":"crear";this.snack.open(n?`No se pudo ${i} la regional. ${n}`:`No se pudo ${i} la regional.`,"OK",{duration:4e3});}finally{this.guardando.set(false);}}cancelar(){this.ref.close();}static \u0275fac=function(e){return new(e||l)};static \u0275cmp=PE({type:l,selectors:[["app-crear-regional-dialog"]],decls:22,vars:7,consts:[["mat-dialog-title",""],[1,"dialog-form"],["appearance","outline"],["matInput","","name","rc","placeholder","QUITO",3,"ngModelChange","ngModel"],["matInput","","name","rn","placeholder","Quito",3,"ngModelChange","ngModel"],["name","ra",3,"ngModel"],["align","end"],["mat-button","",3,"click"],["mat-flat-button","","color","primary",3,"click","disabled"],["name","ra",3,"ngModelChange","ngModel"]],template:function(e,t){e&1&&(si$1(0,"h2",0),ZI(1),Cc(),si$1(2,"mat-dialog-content")(3,"div",1)(4,"mat-form-field",2)(5,"mat-label"),ZI(6,"C\xF3digo"),Cc(),si$1(7,"input",3),Lp("ngModelChange",function(i){return eD(t.form.codigo,i)||(t.form.codigo=i),i}),Cc(),Gv(),si$1(8,"mat-hint"),ZI(9,"Se guarda en MAY\xDASCULAS. Debe ser \xFAnico."),Cc()(),si$1(10,"mat-form-field",2)(11,"mat-label"),ZI(12,"Nombre"),Cc(),si$1(13,"input",4),Lp("ngModelChange",function(i){return eD(t.form.nombre,i)||(t.form.nombre=i),i}),Cc(),Gv(),Cc(),sI(14,fi,2,1,"mat-slide-toggle",5),Cc()(),si$1(15,"mat-dialog-actions",6)(16,"button",7),mp("click",function(){return t.cancelar()}),ZI(17,"Cancelar"),Cc(),si$1(18,"button",8),mp("click",function(){return t.crear()}),si$1(19,"mat-icon"),ZI(20),Cc(),ZI(21),Cc()()),e&2&&(Oy(),kp(t.editando?"Editar regional":"Nueva regional"),Oy(6),Pp("ngModel",t.form.codigo),Qv(),Oy(6),Pp("ngModel",t.form.nombre),Qv(),Oy(),aI(t.editando?14:-1),Oy(4),lp("disabled",t.guardando()),Oy(2),kp(t.editando?"save":"add"),Oy(),xc(" ",t.editando?"Guardar":"Crear regional"," "));},dependencies:[ta,ie,Xn,bn$1,Ht,Nt,zt,Vt,va,ga,yt,wt,de,nt,oe,re,nn,tn,gt,We],styles:[".admin[_ngcontent-%COMP%]{padding:16px;max-width:1100px;margin:0 auto}.admin-head[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;gap:12px}.admin-head[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%]{margin:0;font-size:1.4rem}.tab-body[_ngcontent-%COMP%]{padding:16px 4px}.tab-actions[_ngcontent-%COMP%]{display:flex;justify-content:flex-end;align-items:center;gap:12px;margin-bottom:12px}.buscador[_ngcontent-%COMP%]{display:flex;align-items:center;gap:6px;margin-right:auto;padding:4px 10px;border:1px solid rgba(0,0,0,.18);border-radius:20px;background:#fff;min-width:260px}.buscador[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{color:#0006;font-size:20px;width:20px;height:20px}.buscador[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]{flex:1;border:none;outline:none;background:transparent;font-size:14px}.crear[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;align-items:center;gap:12px;margin-bottom:12px}.crear[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]{width:180px}.crear[_ngcontent-%COMP%]   mat-form-field.ancho[_ngcontent-%COMP%]{width:300px}.crear[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{height:48px}.opt-buscar[_ngcontent-%COMP%]{width:100%;box-sizing:border-box;border:none;outline:none;padding:6px 4px;font:inherit;background:transparent}.acciones[_ngcontent-%COMP%]{width:48px;text-align:center}.acciones.acciones-2[_ngcontent-%COMP%]{width:96px;white-space:nowrap}.rolchips[_ngcontent-%COMP%]{display:inline-flex;flex-wrap:wrap;gap:6px}.chip[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:4px;padding:2px 4px 2px 8px;border-radius:999px;background:#3f51b51f;color:#303f9f;font-size:.78rem;white-space:nowrap}.chip[_ngcontent-%COMP%]   .chip-txt[_ngcontent-%COMP%]{cursor:pointer}.chip[_ngcontent-%COMP%]   .chip-txt[_ngcontent-%COMP%]:hover{text-decoration:underline}.chip[_ngcontent-%COMP%]   .chip-x[_ngcontent-%COMP%]{border:none;background:transparent;color:inherit;cursor:pointer;font-size:1rem;line-height:1;padding:0 2px;border-radius:999px;opacity:.6}.chip[_ngcontent-%COMP%]   .chip-x[_ngcontent-%COMP%]:hover{opacity:1;background:#0000001a}.muted[_ngcontent-%COMP%]{color:#0006;font-style:italic}.dialog-form[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:4px 12px;padding-top:8px;box-sizing:border-box}.dialog-form[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]{flex:1 1 200px;min-width:0}.dialog-form[_ngcontent-%COMP%]   mat-form-field.full[_ngcontent-%COMP%]{flex:1 1 100%}mat-dialog-content[_ngcontent-%COMP%]{overflow-x:hidden}.color-field[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:6px}.color-field.full[_ngcontent-%COMP%]{width:100%}.color-label[_ngcontent-%COMP%]{font-size:.75rem;color:#0009}.swatches[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:8px}.swatch[_ngcontent-%COMP%]{width:30px;height:30px;border-radius:6px;border:2px solid rgba(0,0,0,.12);cursor:pointer;padding:0;position:relative;display:inline-flex;align-items:center;justify-content:center}.swatch.sel[_ngcontent-%COMP%]{border-color:#000000d9;box-shadow:0 0 0 2px #fff inset}.swatch[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:18px;width:18px;height:18px;color:#0000008c}.swatch.custom[_ngcontent-%COMP%]{overflow:hidden;background:repeating-conic-gradient(#eee 0% 25%,#fff 0% 50%) 50%/12px 12px}.swatch.custom[_ngcontent-%COMP%]   input[type=color][_ngcontent-%COMP%]{position:absolute;inset:0;opacity:0;cursor:pointer;border:none;padding:0}.swatch.clear[_ngcontent-%COMP%]{background:#fff}.grid[_ngcontent-%COMP%]{width:100%;border-collapse:collapse;font-size:.9rem}.grid[_ngcontent-%COMP%]   th[_ngcontent-%COMP%], .grid[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{text-align:left;padding:8px 12px;border-bottom:1px solid rgba(0,0,0,.08)}.grid[_ngcontent-%COMP%]   th[_ngcontent-%COMP%]{font-weight:600;color:#0009;white-space:nowrap}.grid[_ngcontent-%COMP%]   th.sortable[_ngcontent-%COMP%]{cursor:pointer;-webkit-user-select:none;user-select:none}.grid[_ngcontent-%COMP%]   th.sortable[_ngcontent-%COMP%]:hover{color:#000000d9}.grid[_ngcontent-%COMP%]   tbody[_ngcontent-%COMP%]   tr[_ngcontent-%COMP%]:hover{background:#00000008}.grid[_ngcontent-%COMP%]   tbody[_ngcontent-%COMP%]   tr.fila-inactiva[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{color:#00000061;font-style:italic}"]})};var bt=class l{ref=D(O);data=D($e);texto=Ft("");coincide=K(()=>this.texto().trim().toUpperCase()===this.data.codigo.trim().toUpperCase());confirmar(){this.coincide()&&this.ref.close(true);}static \u0275fac=function(e){return new(e||l)};static \u0275cmp=PE({type:l,selectors:[["app-eliminar-region-dialog"]],decls:28,vars:5,consts:[["mat-dialog-title","",1,"warn-title"],[1,"muted"],["appearance","outline",1,"full"],["matInput","","name","verif","autocomplete","off",3,"ngModelChange","keydown.enter","ngModel"],["align","end"],["mat-button","",3,"click"],["mat-flat-button","","color","warn",3,"click","disabled"]],template:function(e,t){e&1&&(si$1(0,"h2",0)(1,"mat-icon"),ZI(2,"warning"),Cc(),ZI(3," Eliminar regi\xF3n"),Cc(),si$1(4,"mat-dialog-content")(5,"p"),ZI(6,"Vas a eliminar la regi\xF3n "),si$1(7,"strong"),ZI(8),Cc(),ZI(9),Cc(),si$1(10,"p",1),ZI(11," Se borrar\xE1n tambi\xE9n sus "),si$1(12,"strong"),ZI(13,"equipos vac\xEDos"),Cc(),ZI(14," con su tablero y sprints. Se bloquea si alg\xFAn equipo tiene tareas o t\xE9cnicos exclusivos de esta regi\xF3n. "),si$1(15,"strong"),ZI(16,"Esta acci\xF3n no se puede deshacer."),Cc()(),si$1(17,"mat-form-field",2)(18,"mat-label"),ZI(19),Cc(),si$1(20,"input",3),mp("ngModelChange",function(i){return t.texto.set(i)})("keydown.enter",function(){return t.confirmar()}),Cc(),Gv(),Cc()(),si$1(21,"mat-dialog-actions",4)(22,"button",5),mp("click",function(){return t.ref.close(false)}),ZI(23,"Cancelar"),Cc(),si$1(24,"button",6),mp("click",function(){return t.confirmar()}),si$1(25,"mat-icon"),ZI(26,"delete_outline"),Cc(),ZI(27," Eliminar regi\xF3n "),Cc()()),e&2&&(Oy(8),kp(t.data.nombre),Oy(),xc(" (",t.data.codigo,")."),Oy(10),xc("Escribe ",t.data.codigo," para confirmar"),Oy(),lp("ngModel",t.texto()),Qv(),Oy(4),lp("disabled",!t.coincide()));},dependencies:[ta,ie,Xn,bn$1,Ht,Nt,zt,Vt,va,ga,yt,wt,de,nt,oe,nn,tn],styles:[".full[_ngcontent-%COMP%]{width:100%}.muted[_ngcontent-%COMP%]{color:var(--mat-sys-on-surface-variant, #666);font-size:.9rem}.warn-title[_ngcontent-%COMP%]{display:flex;align-items:center;gap:8px}.warn-title[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{color:#d32f2f}"]})};var ut=(l,a)=>a.id;function vi(l,a){if(l&1){let e=yI();si$1(0,"tr")(1,"td"),ZI(2),Cc(),si$1(3,"td"),ZI(4),Cc(),si$1(5,"td"),ZI(6),Cc(),si$1(7,"td",16)(8,"button",17),mp("click",function(){let n=Xl(e).$implicit,i=EI();return eu(i.editarRegional(n))}),si$1(9,"mat-icon"),ZI(10,"edit"),Cc()(),si$1(11,"button",18),mp("click",function(){let n=Xl(e).$implicit,i=EI();return eu(i.quitarRegional(n))}),si$1(12,"mat-icon"),ZI(13,"delete_outline"),Cc()()()();}if(l&2){let e=a.$implicit;_p("fila-inactiva",!e.activo),Oy(2),kp(e.codigo),Oy(2),kp(e.nombre),Oy(2),kp(e.activo?"S\xED":"No");}}function yi(l,a){if(l&1){let e=yI();si$1(0,"tr")(1,"td"),ZI(2),Cc(),si$1(3,"td"),ZI(4),Cc(),si$1(5,"td"),ZI(6),Cc(),si$1(7,"td"),ZI(8),Cc(),si$1(9,"td"),ZI(10),Cc(),si$1(11,"td",19)(12,"button",20),mp("click",function(){let n=Xl(e).$implicit,i=EI();return eu(i.editarEquipo(n))}),si$1(13,"mat-icon"),ZI(14,"edit"),Cc()()()();}if(l&2){let e=a.$implicit;_p("fila-inactiva",!e.activo),Oy(2),kp(e.codigo),Oy(2),kp(e.nombre),Oy(2),kp(e.regionalNombre),Oy(2),kp(e.responsableNombre||"\u2014"),Oy(2),kp(e.activo?"S\xED":"No");}}function Ci(l,a){if(l&1){let e=yI();si$1(0,"tr")(1,"td"),ZI(2),Cc(),si$1(3,"td"),ZI(4),Cc(),si$1(5,"td"),ZI(6),Cc(),si$1(7,"td"),ZI(8),Cc(),si$1(9,"td"),ZI(10),Cc(),si$1(11,"td",19)(12,"button",21),mp("click",function(){let n=Xl(e).$implicit,i=EI();return eu(i.quitarCliente(n))}),si$1(13,"mat-icon"),ZI(14,"delete_outline"),Cc()()()();}if(l&2){let e=a.$implicit;Oy(2),kp(e.codigo),Oy(2),kp(e.nombre),Oy(2),kp(e.helpdeskClientId||"\u2014"),Oy(2),kp(e.equipoResponsableNombre),Oy(2),kp(e.activo?"S\xED":"No");}}function wi(l,a){if(l&1&&(si$1(0,"span",15),ZI(1),Cc()),l&2){let e=EI();Oy(),Rp("",e.asignacionesFiltradas().length," de ",e.asignaciones().length);}}function xi(l,a){if(l&1){let e=yI();si$1(0,"tr")(1,"td"),ZI(2),Cc(),si$1(3,"td"),ZI(4),Cc(),si$1(5,"td"),ZI(6),Cc(),si$1(7,"td"),ZI(8),Cc(),si$1(9,"td"),ZI(10),Cc(),si$1(11,"td"),ZI(12),Cc(),si$1(13,"td",16)(14,"button",22),mp("click",function(){let n=Xl(e).$implicit,i=EI();return eu(i.editarAsignacion(n))}),si$1(15,"mat-icon"),ZI(16,"edit"),Cc()(),si$1(17,"button",23),mp("click",function(){let n=Xl(e).$implicit,i=EI();return eu(i.quitarAsignacion(n))}),si$1(18,"mat-icon"),ZI(19,"delete_outline"),Cc()()()();}if(l&2){let e=a.$implicit;Oy(2),kp(e.usuarioNombre),Oy(2),kp(e.rolNombre),Oy(2),kp(e.alcanceTipo),Oy(2),kp(e.alcanceNombre),Oy(2),kp(e.vigenteDesde),Oy(2),kp(e.vigenteHasta||"\u2014");}}var wn=class l{api=D(u);hd=D(J);auth=D(Jp);snack=D(Qt);dialog=D(ee);puedeAsignarAdmin=this.auth.puedeAsignarAdmin;regionales=Ft([]);equipos=Ft([]);clientes=Ft([]);roles=Ft([]);asignaciones=Ft([]);cargando=Ft(false);hdUsers=this.hd.hdUsers;asignacionesVista=K(()=>{let a=new Map(this.hdUsers().map(e=>[String(e.id),e.name]));return this.asignaciones().map(e=>{let t=e.helpdeskUserId?String(e.helpdeskUserId):"",n=t?a.get(t):void 0;return n&&n!==t?$(B({},e),{usuarioNombre:n}):e})});equiposVista=K(()=>{let a=new Map(this.hdUsers().map(e=>[String(e.id),e.name]));return this.equipos().map(e=>{let t=e.responsableHelpdeskUserId?String(e.responsableHelpdeskUserId):"",n=t?a.get(t):void 0;return n&&n!==t?$(B({},e),{responsableNombre:n}):e})});asigBuscar=Ft("");asignacionesFiltradas=K(()=>{let a=this.asigBuscar().trim().toLowerCase(),e=this.asignacionesVista();return a?e.filter(t=>(t.usuarioNombre??"").toLowerCase().includes(a)||(t.helpdeskUserId??"").toLowerCase().includes(a)||(t.rolNombre??"").toLowerCase().includes(a)||(t.alcanceNombre??"").toLowerCase().includes(a)):e});sortReg=Ft({col:"nombre",dir:1});sortEq=Ft({col:"nombre",dir:1});sortCli=Ft({col:"nombre",dir:1});sortAsig=Ft({col:"usuarioNombre",dir:1});sorts={reg:this.sortReg,eq:this.sortEq,cli:this.sortCli,asig:this.sortAsig};regionalesOrd=this.ordenar(this.regionales,this.sortReg);equiposOrd=this.ordenar(this.equiposVista,this.sortEq);clientesOrd=this.ordenar(this.clientes,this.sortCli);asignacionesOrd=this.ordenar(this.asignacionesFiltradas,this.sortAsig);constructor(){this.recargar(),this.hd.getHdUsers();}ordenar(a,e){return K(()=>{let{col:t,dir:n}=e();return [...a()].sort((i,p)=>this.cmp(i[t],p[t])*n)})}cmp(a,e){return a==null&&e==null?0:a==null?-1:e==null?1:typeof a=="number"&&typeof e=="number"?a-e:typeof a=="boolean"&&typeof e=="boolean"?a===e?0:a?1:-1:String(a).localeCompare(String(e),"es",{numeric:true,sensitivity:"base"})}ordenarPor(a,e){let t=this.sorts[a];if(!t)return;let n=t();t.set({col:e,dir:n.col===e?n.dir*-1:1});}flecha(a,e){let t=this.sorts[a]?.();return t&&t.col===e?t.dir===1?" \u25B2":" \u25BC":""}async recargar(){this.cargando.set(true);try{let[a,e,t,n,i]=await Promise.all([this.api.regionales(),this.api.equipos(),this.api.clientes(),this.api.roles(),this.api.asignaciones()]);this.regionales.set(a),this.equipos.set(e),this.clientes.set(t),this.roles.set(n),this.asignaciones.set(i);}catch{this.snack.open("No se pudieron cargar los datos de administraci\xF3n.","OK",{duration:4e3});}finally{this.cargando.set(false);}}async nuevaRegional(){await ah(this.dialog.open(Qe,{width:"420px",maxWidth:"95vw"}).afterClosed())&&await this.recargar();}async editarRegional(a){await ah(this.dialog.open(Qe,{data:{regional:a},width:"420px",maxWidth:"95vw"}).afterClosed())&&await this.recargar();}async quitarRegional(a){if(await ah(this.dialog.open(bt,{data:{codigo:a.codigo,nombre:a.nombre},width:"440px",maxWidth:"95vw"}).afterClosed()))try{await this.api.eliminarRegional(a.id),this.snack.open("Regional eliminada","",{duration:2e3}),await this.recargar();}catch(t){let n=t?.error?.error;this.snack.open(n??"No se pudo eliminar la regional.","OK",{duration:5e3});}}async nuevoEquipo(){await ah(this.dialog.open(je,{data:{regionales:this.regionales()},width:"460px",maxWidth:"95vw"}).afterClosed())&&await this.recargar();}async editarEquipo(a){await ah(this.dialog.open(je,{data:{regionales:this.regionales(),equipo:a},width:"460px",maxWidth:"95vw"}).afterClosed())&&await this.recargar();}equiposParaSelector(a){let e=this.equipos().filter(t=>t.activo);if(a!=null&&!e.some(t=>t.id===a)){let t=this.equipos().find(n=>n.id===a);if(t)return [...e,t]}return e}async nuevoCliente(){await ah(this.dialog.open(mt,{data:{equipos:this.equiposParaSelector(),yaRegistrados:this.clientes().map(e=>String(e.helpdeskClientId))},width:"560px",maxWidth:"95vw"}).afterClosed())&&await this.recargar();}async quitarCliente(a){if(confirm(`\xBFQuitar el cliente "${a.nombre}"? Se desliga de su equipo/regi\xF3n y se borra.`))try{await this.api.eliminarCliente(a.id),this.snack.open("Cliente quitado","",{duration:2e3}),await this.recargar();}catch{this.snack.open("No se pudo quitar el cliente.","OK",{duration:4e3});}}async nuevaAsignacion(a){await ah(this.dialog.open(qe,{data:{roles:this.roles(),equipos:this.equiposParaSelector(),clientes:this.clientes(),regionales:this.regionales(),usuarioPreHid:a},width:"560px",maxWidth:"95vw"}).afterClosed())&&await this.recargar();}async editarAsignacion(a){if(a.rolCodigo==="ADMIN"&&!this.puedeAsignarAdmin()){this.snack.open("Solo un ADMIN puede modificar asignaciones de rol ADMIN.","OK",{duration:4e3});return}await ah(this.dialog.open(qe,{data:{roles:this.roles(),equipos:this.equiposParaSelector(a.alcanceTipo==="EQUIPO"?a.alcanceObjetivoId:null),clientes:this.clientes(),regionales:this.regionales(),asignacion:a},width:"560px",maxWidth:"95vw"}).afterClosed())&&await this.recargar();}async quitarAsignacion(a){if(a.rolCodigo==="ADMIN"&&!this.puedeAsignarAdmin()){this.snack.open("Solo un ADMIN puede quitar asignaciones de rol ADMIN.","OK",{duration:4e3});return}if(confirm(`\xBFQuitar la asignaci\xF3n "${a.usuarioNombre} \xB7 ${a.rolCodigo} \xB7 ${a.alcanceNombre??""}"?`))try{await this.api.eliminarAsignacion(a.id),this.snack.open("Asignaci\xF3n quitada","",{duration:2e3}),await this.recargar();}catch{this.snack.open("No se pudo quitar la asignaci\xF3n.","OK",{duration:4e3});}}static \u0275fac=function(e){return new(e||l)};static \u0275cmp=PE({type:l,selectors:[["app-administracion"]],decls:108,vars:21,consts:[[1,"admin"],[1,"admin-head"],["mat-stroked-button","",3,"click","disabled"],["label","Regionales"],[1,"tab-body"],[1,"tab-actions"],["mat-flat-button","","color","primary",3,"click"],[1,"grid"],[1,"sortable",3,"click"],[3,"fila-inactiva"],["label","Equipos"],["label","Clientes"],["label","Asignaciones"],[1,"buscador"],["type","search","placeholder","Buscar por nombre, rol o alcance\u2026",3,"input","value"],[1,"muted"],[1,"acciones","acciones-2"],["mat-icon-button","","title","Editar regional","aria-label","Editar regional",3,"click"],["mat-icon-button","","color","warn","title","Eliminar regional","aria-label","Eliminar regional",3,"click"],[1,"acciones"],["mat-icon-button","","title","Editar equipo","aria-label","Editar equipo",3,"click"],["mat-icon-button","","color","warn","title","Quitar cliente","aria-label","Quitar cliente",3,"click"],["mat-icon-button","","title","Editar asignaci\xF3n","aria-label","Editar asignaci\xF3n",3,"click"],["mat-icon-button","","color","warn","title","Quitar asignaci\xF3n","aria-label","Quitar asignaci\xF3n",3,"click"]],template:function(e,t){e&1&&(si$1(0,"div",0)(1,"header",1)(2,"h1"),ZI(3,"Administraci\xF3n"),Cc(),si$1(4,"button",2),mp("click",function(){return t.recargar()}),si$1(5,"mat-icon"),ZI(6,"refresh"),Cc(),ZI(7," Recargar "),Cc()(),si$1(8,"mat-tab-group")(9,"mat-tab",3)(10,"div",4)(11,"div",5)(12,"button",6),mp("click",function(){return t.nuevaRegional()}),si$1(13,"mat-icon"),ZI(14,"add"),Cc(),ZI(15," Nueva regional "),Cc()(),si$1(16,"table",7)(17,"thead")(18,"tr")(19,"th",8),mp("click",function(){return t.ordenarPor("reg","codigo")}),ZI(20),Cc(),si$1(21,"th",8),mp("click",function(){return t.ordenarPor("reg","nombre")}),ZI(22),Cc(),si$1(23,"th",8),mp("click",function(){return t.ordenarPor("reg","activo")}),ZI(24),Cc(),up(25,"th"),Cc()(),si$1(26,"tbody"),uI(27,vi,14,5,"tr",9,ut),Cc()()()(),si$1(29,"mat-tab",10)(30,"div",4)(31,"div",5)(32,"button",6),mp("click",function(){return t.nuevoEquipo()}),si$1(33,"mat-icon"),ZI(34,"add"),Cc(),ZI(35," Nuevo equipo "),Cc()(),si$1(36,"table",7)(37,"thead")(38,"tr")(39,"th",8),mp("click",function(){return t.ordenarPor("eq","codigo")}),ZI(40),Cc(),si$1(41,"th",8),mp("click",function(){return t.ordenarPor("eq","nombre")}),ZI(42),Cc(),si$1(43,"th",8),mp("click",function(){return t.ordenarPor("eq","regionalNombre")}),ZI(44),Cc(),si$1(45,"th",8),mp("click",function(){return t.ordenarPor("eq","responsableNombre")}),ZI(46),Cc(),si$1(47,"th",8),mp("click",function(){return t.ordenarPor("eq","activo")}),ZI(48),Cc(),up(49,"th"),Cc()(),si$1(50,"tbody"),uI(51,yi,15,7,"tr",9,ut),Cc()()()(),si$1(53,"mat-tab",11)(54,"div",4)(55,"div",5)(56,"button",6),mp("click",function(){return t.nuevoCliente()}),si$1(57,"mat-icon"),ZI(58,"add"),Cc(),ZI(59," Nuevo cliente "),Cc()(),si$1(60,"table",7)(61,"thead")(62,"tr")(63,"th",8),mp("click",function(){return t.ordenarPor("cli","codigo")}),ZI(64),Cc(),si$1(65,"th",8),mp("click",function(){return t.ordenarPor("cli","nombre")}),ZI(66),Cc(),si$1(67,"th",8),mp("click",function(){return t.ordenarPor("cli","helpdeskClientId")}),ZI(68),Cc(),si$1(69,"th",8),mp("click",function(){return t.ordenarPor("cli","equipoResponsableNombre")}),ZI(70),Cc(),si$1(71,"th",8),mp("click",function(){return t.ordenarPor("cli","activo")}),ZI(72),Cc(),up(73,"th"),Cc()(),si$1(74,"tbody"),uI(75,Ci,15,5,"tr",null,ut),Cc()()()(),si$1(77,"mat-tab",12)(78,"div",4)(79,"div",5)(80,"div",13)(81,"mat-icon"),ZI(82,"search"),Cc(),si$1(83,"input",14),mp("input",function(i){return t.asigBuscar.set(i.target.value)}),Cc()(),sI(84,wi,2,2,"span",15),si$1(85,"button",6),mp("click",function(){return t.nuevaAsignacion()}),si$1(86,"mat-icon"),ZI(87,"add"),Cc(),ZI(88," Nueva asignaci\xF3n "),Cc()(),si$1(89,"table",7)(90,"thead")(91,"tr")(92,"th",8),mp("click",function(){return t.ordenarPor("asig","usuarioNombre")}),ZI(93),Cc(),si$1(94,"th",8),mp("click",function(){return t.ordenarPor("asig","rolCodigo")}),ZI(95),Cc(),si$1(96,"th",8),mp("click",function(){return t.ordenarPor("asig","alcanceTipo")}),ZI(97),Cc(),si$1(98,"th",8),mp("click",function(){return t.ordenarPor("asig","alcanceNombre")}),ZI(99),Cc(),si$1(100,"th",8),mp("click",function(){return t.ordenarPor("asig","vigenteDesde")}),ZI(101),Cc(),si$1(102,"th"),ZI(103,"Hasta"),Cc(),up(104,"th"),Cc()(),si$1(105,"tbody"),uI(106,xi,20,6,"tr",null,ut),Cc()()()()()()),e&2&&(Oy(4),lp("disabled",t.cargando()),Oy(16),xc("C\xF3digo",t.flecha("reg","codigo")),Oy(2),xc("Nombre",t.flecha("reg","nombre")),Oy(2),xc("Activo",t.flecha("reg","activo")),Oy(3),dI(t.regionalesOrd()),Oy(13),xc("C\xF3digo",t.flecha("eq","codigo")),Oy(2),xc("Nombre",t.flecha("eq","nombre")),Oy(2),xc("Regional",t.flecha("eq","regionalNombre")),Oy(2),xc("Responsable",t.flecha("eq","responsableNombre")),Oy(2),xc("Activo",t.flecha("eq","activo")),Oy(3),dI(t.equiposOrd()),Oy(13),xc("C\xF3digo",t.flecha("cli","codigo")),Oy(2),xc("Nombre",t.flecha("cli","nombre")),Oy(2),xc("ID HD",t.flecha("cli","helpdeskClientId")),Oy(2),xc("Equipo responsable",t.flecha("cli","equipoResponsableNombre")),Oy(2),xc("Activo",t.flecha("cli","activo")),Oy(3),dI(t.clientesOrd()),Oy(8),lp("value",t.asigBuscar()),Oy(),aI(t.asigBuscar().trim()?84:-1),Oy(9),xc("Usuario",t.flecha("asig","usuarioNombre")),Oy(2),xc("Rol",t.flecha("asig","rolCodigo")),Oy(2),xc("Alcance",t.flecha("asig","alcanceTipo")),Oy(2),xc("Objetivo",t.flecha("asig","alcanceNombre")),Oy(2),xc("Desde",t.flecha("asig","vigenteDesde")),Oy(5),dI(t.asignacionesOrd()));},dependencies:[hn,Dt,un,va,ga,An$1,yt,wt],styles:[".admin[_ngcontent-%COMP%]{padding:16px;max-width:1100px;margin:0 auto}.admin-head[_ngcontent-%COMP%]{display:flex;align-items:center;justify-content:space-between;gap:12px}.admin-head[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%]{margin:0;font-size:1.4rem}.tab-body[_ngcontent-%COMP%]{padding:16px 4px}.tab-actions[_ngcontent-%COMP%]{display:flex;justify-content:flex-end;align-items:center;gap:12px;margin-bottom:12px}.buscador[_ngcontent-%COMP%]{display:flex;align-items:center;gap:6px;margin-right:auto;padding:4px 10px;border:1px solid rgba(0,0,0,.18);border-radius:20px;background:#fff;min-width:260px}.buscador[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{color:#0006;font-size:20px;width:20px;height:20px}.buscador[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]{flex:1;border:none;outline:none;background:transparent;font-size:14px}.crear[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;align-items:center;gap:12px;margin-bottom:12px}.crear[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]{width:180px}.crear[_ngcontent-%COMP%]   mat-form-field.ancho[_ngcontent-%COMP%]{width:300px}.crear[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{height:48px}.opt-buscar[_ngcontent-%COMP%]{width:100%;box-sizing:border-box;border:none;outline:none;padding:6px 4px;font:inherit;background:transparent}.acciones[_ngcontent-%COMP%]{width:48px;text-align:center}.acciones.acciones-2[_ngcontent-%COMP%]{width:96px;white-space:nowrap}.rolchips[_ngcontent-%COMP%]{display:inline-flex;flex-wrap:wrap;gap:6px}.chip[_ngcontent-%COMP%]{display:inline-flex;align-items:center;gap:4px;padding:2px 4px 2px 8px;border-radius:999px;background:#3f51b51f;color:#303f9f;font-size:.78rem;white-space:nowrap}.chip[_ngcontent-%COMP%]   .chip-txt[_ngcontent-%COMP%]{cursor:pointer}.chip[_ngcontent-%COMP%]   .chip-txt[_ngcontent-%COMP%]:hover{text-decoration:underline}.chip[_ngcontent-%COMP%]   .chip-x[_ngcontent-%COMP%]{border:none;background:transparent;color:inherit;cursor:pointer;font-size:1rem;line-height:1;padding:0 2px;border-radius:999px;opacity:.6}.chip[_ngcontent-%COMP%]   .chip-x[_ngcontent-%COMP%]:hover{opacity:1;background:#0000001a}.muted[_ngcontent-%COMP%]{color:#0006;font-style:italic}.dialog-form[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:4px 12px;padding-top:8px;box-sizing:border-box}.dialog-form[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%]{flex:1 1 200px;min-width:0}.dialog-form[_ngcontent-%COMP%]   mat-form-field.full[_ngcontent-%COMP%]{flex:1 1 100%}mat-dialog-content[_ngcontent-%COMP%]{overflow-x:hidden}.color-field[_ngcontent-%COMP%]{display:flex;flex-direction:column;gap:6px}.color-field.full[_ngcontent-%COMP%]{width:100%}.color-label[_ngcontent-%COMP%]{font-size:.75rem;color:#0009}.swatches[_ngcontent-%COMP%]{display:flex;flex-wrap:wrap;gap:8px}.swatch[_ngcontent-%COMP%]{width:30px;height:30px;border-radius:6px;border:2px solid rgba(0,0,0,.12);cursor:pointer;padding:0;position:relative;display:inline-flex;align-items:center;justify-content:center}.swatch.sel[_ngcontent-%COMP%]{border-color:#000000d9;box-shadow:0 0 0 2px #fff inset}.swatch[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:18px;width:18px;height:18px;color:#0000008c}.swatch.custom[_ngcontent-%COMP%]{overflow:hidden;background:repeating-conic-gradient(#eee 0% 25%,#fff 0% 50%) 50%/12px 12px}.swatch.custom[_ngcontent-%COMP%]   input[type=color][_ngcontent-%COMP%]{position:absolute;inset:0;opacity:0;cursor:pointer;border:none;padding:0}.swatch.clear[_ngcontent-%COMP%]{background:#fff}.grid[_ngcontent-%COMP%]{width:100%;border-collapse:collapse;font-size:.9rem}.grid[_ngcontent-%COMP%]   th[_ngcontent-%COMP%], .grid[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{text-align:left;padding:8px 12px;border-bottom:1px solid rgba(0,0,0,.08)}.grid[_ngcontent-%COMP%]   th[_ngcontent-%COMP%]{font-weight:600;color:#0009;white-space:nowrap}.grid[_ngcontent-%COMP%]   th.sortable[_ngcontent-%COMP%]{cursor:pointer;-webkit-user-select:none;user-select:none}.grid[_ngcontent-%COMP%]   th.sortable[_ngcontent-%COMP%]:hover{color:#000000d9}.grid[_ngcontent-%COMP%]   tbody[_ngcontent-%COMP%]   tr[_ngcontent-%COMP%]:hover{background:#00000008}.grid[_ngcontent-%COMP%]   tbody[_ngcontent-%COMP%]   tr.fila-inactiva[_ngcontent-%COMP%]   td[_ngcontent-%COMP%]{color:#00000061;font-style:italic}"]})};export{wn as Administracion};