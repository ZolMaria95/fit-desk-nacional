import {f,y as yE,g as fe,S as Sh,aK as sn,F,j as u2,W,o as oe,p as pi,k as da$1,aL as s,aM as r$1,aN as o_,K as Kt$1,aO as W$1,aP as zt$1,aQ as mt,L as La$1,a as yT,A as Ja$1,i as iS,m as mf,e as ec,ah as iy,P as IT,aR as LT,J as Jw,D as DT,u as uy,Q as wT,B as Dy,C as FT,G as _t$2,E as vi,H as Wo$1,N as No$1,I as jo$1,O as zo$1,ag as AT,l as lC,M as My,a3 as nc,ae as _i,b as fC,w as wf,$ as $e,T as Oe$1,a7 as Kt$2,U as ge,as as bi,aS as ct,ax as fR,an as y,ao as U,aT as Lh,ap as re,ar as X,aB as Oo$1,at as Bt$2,aU as Zc,a9 as Rh,aD as T_,aG as De,aV as Xt$1,ad as Ly,ak as H$1,aW as wn,aX as de,aY as x,aZ as Pt,av as Re,a_ as xe,a$ as Fe$1,b0 as At$1,b1 as f2,b2 as P4,X as XE,au as VE,a4 as tc,a5 as _f,a6 as If,aj as ME,ay as Xc,b3 as wr,b4 as S4,b5 as sc,b6 as b4,b7 as J,a0 as OT,a1 as kT,aw as vy,b8 as e3,b9 as a2,ba as Vh,Z as L,bb as V4,bc as nu,bd as hy,a2 as ZT,aa as xm,ac as ry,az as cr$1,be as Ph,bf as vf,bg as yf,bh as m,bi as Dg,bj as Eg,bk as Vs,c as RT,aH as sg,aI as ag,bl as b$1,aA as tt,bm as ut$2,al as yi,bn as ee,bo as C_,bp as Ah,bq as ht,br as Ki,bs as Yi,bt as _T,af as Iy,bu as c_,bv as ie,bw as ky,bx as dS,by as fS,bz as vS,aJ as rv}from'./main-IGCS5HIE.js';import {_,I}from'./chunk-BfV1YhJI.js';import {O as Oi}from'./chunk-CSxZlfey.js';import {O as Or,K as Kn$1,h as hn,Y as Yr,_ as _t$1,j as jr,z as zr,N as Nr,B as Br,L as Lr,T as Tr,P as Pr,I as Ir,E as Er,R as Rr,U as Ur,u as ut$1,V as Vr,H as Hr,F as Fr,o as on,r as rn,a as zs,b as Ys,c as Rn}from'./chunk-D2ezY7KL.js';import {L as Lt$1,P,G,N as Nt$1}from'./chunk-CyfN8UXM.js';import'./chunk-CmfDwFqP.js';import'./chunk-lzbQ1BoW.js';import'./chunk-DJxAWDP0.js';import {s as s$1}from'./chunk-DL780i6E.js';import {d,f as f$1}from'./chunk-Crmz8xcl.js';import {T}from'./chunk-DjBwG-eD.js';import {p}from'./chunk-WuUVgyF6.js';import {Q as Qt$1}from'./chunk-Bqk5aojL.js';import {B as Bt$1,W as Wt$1,b}from'./chunk-B3wxv9FY.js';import {v}from'./chunk-CTX3j4Gp.js';import {K}from'./chunk-BpwDfdJ-.js';import {y as yt,w as wt}from'./chunk-D_x4GnM7.js';import {A as Aa$1,F as Fa$1,e as eo$1,h as he,Z as Zn$1,m as me,u as ue,I as Io$1,L as Lr$1,z as zr$1,d as da$2,l as ln,i as ia$1,a as Di,j as ji,_ as _t$3,K as K$1}from'./chunk-DmEXYBRz.js';function Bt(a){let i=a.cloneNode(true),e=i.querySelectorAll("[id]"),t=a.nodeName.toLowerCase();i.removeAttribute("id");for(let n=0;n<e.length;n++)e[n].removeAttribute("id");return t==="canvas"?Nn(a,i):(t==="input"||t==="select"||t==="textarea")&&Ln(a,i),Bn("canvas",a,i,Nn),Bn("input, textarea, select",a,i,Ln),i}function Bn(a,i,e,t){let n=i.querySelectorAll(a);if(n.length){let o=e.querySelectorAll(a);for(let r=0;r<n.length;r++)t(n[r],o[r]);}}var Da=0;function Ln(a,i){i.type!=="file"&&(i.value=a.value),i.type==="radio"&&i.name&&(i.name=`mat-clone-${i.name}-${Da++}`);}function Nn(a,i){let e=i.getContext("2d");if(e)try{e.drawImage(a,0,0);}catch{}}function qt(a){let i=a.getBoundingClientRect();return {top:i.top,right:i.right,bottom:i.bottom,left:i.left,width:i.width,height:i.height,x:i.x,y:i.y}}function Lt(a,i,e){let{top:t,bottom:n,left:o,right:r}=a;return e>=t&&e<=n&&i>=o&&i<=r}function Pa(a,i){let e=i.left<a.left,t=i.left+i.width>a.right,n=i.top<a.top,o=i.top+i.height>a.bottom;return e||t||n||o}function Ae(a,i,e){a.top+=i,a.bottom=a.top+a.height,a.left+=e,a.right=a.left+a.width;}function Vn(a,i,e,t){let{top:n,right:o,bottom:r,left:l,width:p,height:_}=a,v=p*i,b=_*i;return t>n-b&&t<r+b&&e>l-v&&e<o+v}var ut=class{_document;positions=new Map;constructor(i){this._document=i;}clear(){this.positions.clear();}cache(i){this.clear(),this.positions.set(this._document,{scrollPosition:this.getViewportScrollPosition()}),i.forEach(e=>{this.positions.set(e,{scrollPosition:{top:e.scrollTop,left:e.scrollLeft},clientRect:qt(e)});});}handleScroll(i){let e=ht(i),t=this.positions.get(e);if(!t)return null;let n=t.scrollPosition,o,r;if(e===this._document){let _=this.getViewportScrollPosition();o=_.top,r=_.left;}else o=e.scrollTop,r=e.scrollLeft;let l=n.top-o,p=n.left-r;return this.positions.forEach((_,v)=>{_.clientRect&&e!==v&&e.contains(v)&&Ae(_.clientRect,l,p);}),n.top=o,n.left=r,{top:l,left:p}}getViewportScrollPosition(){return {top:window.scrollY,left:window.scrollX}}};function Yn(a,i){let e=a.rootNodes;if(e.length===1&&e[0].nodeType===i.ELEMENT_NODE)return e[0];let t=i.createElement("div");return e.forEach(n=>t.appendChild(n)),t}function jt(a,i,e){for(let t in i)if(i.hasOwnProperty(t)){let n=i[t];n?a.setProperty(t,n,e?.has(t)?"important":""):a.removeProperty(t);}return a}function we(a,i){let e=i?"":"none";jt(a.style,{"touch-action":i?"":"none","-webkit-user-drag":i?"":"none","-webkit-tap-highlight-color":i?"":"transparent","user-select":e,"-ms-user-select":e,"-webkit-user-select":e,"-moz-user-select":e});}function zn(a,i,e){jt(a.style,{position:i?"":"fixed",top:i?"":"0",opacity:i?"":"0",left:i?"":"-999em"},e);}function gt(a,i){return i&&i!="none"?a+" "+i:a}function Hn(a,i){a.style.width=`${i.width}px`,a.style.height=`${i.height}px`,a.style.transform=Be(i.left,i.top);}function Be(a,i){return `translate3d(${Math.round(a)}px, ${Math.round(i)}px, 0)`}var Oe={capture:true},Ft={passive:false,capture:true},Ma=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=Kt$1({type:a,selectors:[["ng-component"]],hostAttrs:["cdk-drag-resets-container",""],decls:0,vars:0,template:function(t,n){},styles:[`@layer cdk-resets {
  .cdk-drag-preview {
    background: none;
    border: none;
    padding: 0;
