import {f,E as EE,c as fe,S as Sh,aK as sn,F,h as v2,W,g as ce,p as pi,aL as d_,aM as j,aN as m,K as Kt$1,aO as W$1,aP as zt$1,aQ as mt,L as La,C as CT,J as Ja$1,a as fS,m as mf,e as ec,ah as ay,H as AT,aR as zT,s as sb,T as TT,d as dy,I as NT,t as _y,$ as $T,y as _t$2,x as vi,z as Wo$1,A as No$1,B as jo$1,G as zo$1,ag as FT,v as vC,N as Ny,a3 as nc,ae as _i,D as DC,w as wf,P as $e,Q as Oe$1,a7 as Kt$2,X as ge,as as bi,aS as ct,ax as DR,an as y,ao as U,aT as Lh,ap as re,ar as X,aB as Oo$1,at as Bt$2,aU as Zc,a9 as Rh,aD as O_,aG as De,aV as Xt$1,ad as Uy,ak as H$1,aW as wn,aX as de,aY as x,aZ as Pt,av as Re$1,a_ as xe,a$ as Fe$1,b0 as At$1,b1 as E2,b2 as $4,U as e_,au as zE,a4 as tc,a5 as _f,a6 as If,aj as NE,ay as Xc,b3 as wr,b4 as P4,b5 as sc,b6 as x4,b7 as J,a0 as BT,a1 as HT,aw as Dy,b8 as c3,b9 as g2,ba as Vh,Z as L,bb as K4,bc as nu,bd as gy,a2 as tS,aa as km,ac as iy,az as cr,be as Ph,bf as vf,bg as yf,bh as m$1,bi as _g,bj as Ig,bk as Vs,j as jT,aH as cg,aI as ug,bl as b$1,aA as tt,bm as ut$2,al as yi,bn as ee,bo as x_,bp as Ah,bq as ht,br as Ki,bs as Yi,bt as MT,af as by,bu as g_,bv as Fy,bw as yS,bx as DS,by as bS,aJ as iv}from'./main-KXBGDWKU.js';import {_,I}from'./chunk-C1vXk0Ke.js';import {d,f as f$1}from'./chunk-kWORCmso.js';import {T}from'./chunk-Bhgt_iZH.js';import {O as Oi}from'./chunk--0sAb--_.js';import {T as Tr,$ as $n$1,h as hn,L as Lr,_ as _t$1,H as Hr,Y as Yr,B as Br,R as Rr,N as Nr,E as Er,O as Or,P as Pr,S as Sr,F as Fr,j as jr,u as ut$1,I as Ir,z as zr,V as Vr,o as on,r as rn,a as Ys,b as Ls,c as Rn}from'./chunk-DD1D28ws.js';import'./chunk-8aBjgd-Y.js';import {L as Lt$1,P,G,N as Nt$1}from'./chunk-BTMOQmUt.js';import {v}from'./chunk-CNJDcUks.js';import'./chunk-BuW9cZNt.js';import {s}from'./chunk-DL780i6E.js';import'./chunk-PNaoXl1o.js';import {p}from'./chunk-CSufvVN0.js';import {Q as Qt$1}from'./chunk-DGBWXcsp.js';import {B as Bt$1,W as Wt$1,b}from'./chunk-CgOCqtiN.js';import {K}from'./chunk-D9hY9SeW.js';import {y as yt,w as wt}from'./chunk-BceFUdRi.js';import {A as Aa$1,F as Fa$1,e as eo$1,h as he,Z as Zn$1,m as me,u as ue,I as Io$1,L as Lr$1,z as zr$1,d as da$1,l as ln,i as ia$1,a as Di,j as ji,_ as _t$3,K as K$1}from'./chunk-xB569YPp.js';function At(a){let i=a.cloneNode(true),e=i.querySelectorAll("[id]"),t=a.nodeName.toLowerCase();i.removeAttribute("id");for(let n=0;n<e.length;n++)e[n].removeAttribute("id");return t==="canvas"?Bn(a,i):(t==="input"||t==="select"||t==="textarea")&&An(a,i),Fn("canvas",a,i,Bn),Fn("input, textarea, select",a,i,An),i}function Fn(a,i,e,t){let n=i.querySelectorAll(a);if(n.length){let o=e.querySelectorAll(a);for(let r=0;r<n.length;r++)t(n[r],o[r]);}}var wa=0;function An(a,i){i.type!=="file"&&(i.value=a.value),i.type==="radio"&&i.name&&(i.name=`mat-clone-${i.name}-${wa++}`);}function Bn(a,i){let e=i.getContext("2d");if(e)try{e.drawImage(a,0,0);}catch{}}function Gt(a){let i=a.getBoundingClientRect();return {top:i.top,right:i.right,bottom:i.bottom,left:i.left,width:i.width,height:i.height,x:i.x,y:i.y}}function Bt(a,i,e){let{top:t,bottom:n,left:o,right:r}=a;return e>=t&&e<=n&&i>=o&&i<=r}function Sa(a,i){let e=i.left<a.left,t=i.left+i.width>a.right,n=i.top<a.top,o=i.top+i.height>a.bottom;return e||t||n||o}function Oe(a,i,e){a.top+=i,a.bottom=a.top+a.height,a.left+=e,a.right=a.left+a.width;}function Ln(a,i,e,t){let{top:n,right:o,bottom:r,left:d,width:p,height:_}=a,v=p*i,b=_*i;return t>n-b&&t<r+b&&e>d-v&&e<o+v}var ut=class{_document;positions=new Map;constructor(i){this._document=i;}clear(){this.positions.clear();}cache(i){this.clear(),this.positions.set(this._document,{scrollPosition:this.getViewportScrollPosition()}),i.forEach(e=>{this.positions.set(e,{scrollPosition:{top:e.scrollTop,left:e.scrollLeft},clientRect:Gt(e)});});}handleScroll(i){let e=ht(i),t=this.positions.get(e);if(!t)return null;let n=t.scrollPosition,o,r;if(e===this._document){let _=this.getViewportScrollPosition();o=_.top,r=_.left;}else o=e.scrollTop,r=e.scrollLeft;let d=n.top-o,p=n.left-r;return this.positions.forEach((_,v)=>{_.clientRect&&e!==v&&e.contains(v)&&Oe(_.clientRect,d,p);}),n.top=o,n.left=r,{top:d,left:p}}getViewportScrollPosition(){return {top:window.scrollY,left:window.scrollX}}};function Kn(a,i){let e=a.rootNodes;if(e.length===1&&e[0].nodeType===i.ELEMENT_NODE)return e[0];let t=i.createElement("div");return e.forEach(n=>t.appendChild(n)),t}function qt(a,i,e){for(let t in i)if(i.hasOwnProperty(t)){let n=i[t];n?a.setProperty(t,n,e?.has(t)?"important":""):a.removeProperty(t);}return a}function we(a,i){let e=i?"":"none";qt(a.style,{"touch-action":i?"":"none","-webkit-user-drag":i?"":"none","-webkit-tap-highlight-color":i?"":"transparent","user-select":e,"-ms-user-select":e,"-webkit-user-select":e,"-moz-user-select":e});}function Nn(a,i,e){qt(a.style,{position:i?"":"fixed",top:i?"":"0",opacity:i?"":"0",left:i?"":"-999em"},e);}function gt(a,i){return i&&i!="none"?a+" "+i:a}function Vn(a,i){a.style.width=`${i.width}px`,a.style.height=`${i.height}px`,a.style.transform=Fe(i.left,i.top);}function Fe(a,i){return `translate3d(${Math.round(a)}px, ${Math.round(i)}px, 0)`}var Te={capture:true},Ot={passive:false,capture:true},Da=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=Kt$1({type:a,selectors:[["ng-component"]],hostAttrs:["cdk-drag-resets-container",""],decls:0,vars:0,template:function(t,n){},styles:[`@layer cdk-resets {
  .cdk-drag-preview {
    background: none;
    border: none;
    padding: 0;
