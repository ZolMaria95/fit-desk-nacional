import {f,y as yE,g as fe,S as Sh,aK as sn,F,j as u2,W,o as oe,p as pi,k as da$1,aL as s,aM as r$1,aN as o_,K as Kt$1,aO as W$1,aP as zt$1,aQ as mt,L as La,a as yT,A as Ja$1,i as iS,m as mf,e as ec,ah as iy,P as IT,aR as LT,J as Jw,D as DT,u as uy,Q as wT,B as Dy,C as FT,G as _t$2,E as vi,H as Wo$1,N as No$1,I as jo$1,O as zo$1,ag as AT,l as lC,M as My,a3 as nc,ae as _i,b as fC,w as wf,$ as $e,T as Oe,a7 as Kt$2,U as ge,as as bi,aS as ct,ax as fR,an as y,ao as U,aT as Lh,ap as re,ar as X,aB as Oo$1,at as Bt$2,aU as Zc,a9 as Rh,aD as T_,aG as De,aV as Xt$1,ad as Ly,ak as H$1,aW as wn,aX as de,aY as x,aZ as Pt,av as Re,a_ as xe,a$ as Fe$1,b0 as At$1,b1 as f2,b2 as P4,X as XE,au as VE,a4 as tc,a5 as _f,a6 as If,aj as ME,ay as Xc,b3 as wr,b4 as S4,b5 as sc,b6 as b4,b7 as J,a0 as OT,a1 as kT,aw as vy,b8 as e3,b9 as a2,ba as Vh,Z as L,bb as V4,bc as nu,bd as hy,a2 as ZT,aa as xm,ac as ry,az as cr$1,be as Ph,bf as vf,bg as yf,bh as m,bi as Dg,bj as Eg,bk as Vs,c as RT,aH as sg,aI as ag,bl as b$1,aA as tt,bm as ut$1,al as yi,bn as ee,bo as C_,bp as Ah,bq as ht,br as Ki,bs as Yi,bt as _T,af as Iy,bu as c_,bv as ie,bw as ky,bx as dS,by as fS,bz as vS,aJ as rv}from'./main-MTBBFX4V.js';import {_,I}from'./chunk-BoMjAlXT.js';import {O as Oi}from'./chunk-DrZwyxm-.js';import {O as Or,K as Kn$1,h as hn,Y as Yr,_ as _t$1,j as jr,z as zr,N as Nr,B as Br,L as Lr,T as Tr,P as Pr,I as Ir,E as Er,R as Rr,U as Ur,u as ut,V as Vr,H as Hr,F as Fr,o as on,r as rn,a as zs,b as Ys,c as Rn}from'./chunk-DObdl2if.js';import {L as Lt$1,P,G,N as Nt$1}from'./chunk-DYS7R3Il.js';import'./chunk-DROzePk3.js';import'./chunk-DZt5hkPZ.js';import'./chunk-CTFb5Wmv.js';import {s as s$1}from'./chunk-DL780i6E.js';import {o}from'./chunk-CPJy2Ane.js';import {T}from'./chunk-DEKEf8OA.js';import {p}from'./chunk-BTldzIRa.js';import {Q as Qt$1}from'./chunk-DB4rLS1x.js';import {B as Bt$1,W as Wt$1,b}from'./chunk-DyXPgKMe.js';import {v}from'./chunk-C24dBVWn.js';import {K}from'./chunk-ComZOjr5.js';import {y as yt,w as wt}from'./chunk-BefXzKhy.js';import {A as Aa$1,F as Fa$1,e as eo$1,h as he,Z as Zn$1,m as me,u as ue,I as Io$1,L as Lr$1,z as zr$1,d as da$2,l as ln,i as ia$1,a as Di,j as ji,_ as _t$3,K as K$1}from'./chunk-UTeYxW8J.js';function Bt(a){let i=a.cloneNode(true),e=i.querySelectorAll("[id]"),t=a.nodeName.toLowerCase();i.removeAttribute("id");for(let n=0;n<e.length;n++)e[n].removeAttribute("id");return t==="canvas"?Nn(a,i):(t==="input"||t==="select"||t==="textarea")&&Bn(a,i),An("canvas",a,i,Nn),An("input, textarea, select",a,i,Bn),i}function An(a,i,e,t){let n=i.querySelectorAll(a);if(n.length){let o=e.querySelectorAll(a);for(let r=0;r<n.length;r++)t(n[r],o[r]);}}var Sa=0;function Bn(a,i){i.type!=="file"&&(i.value=a.value),i.type==="radio"&&i.name&&(i.name=`mat-clone-${i.name}-${Sa++}`);}function Nn(a,i){let e=i.getContext("2d");if(e)try{e.drawImage(a,0,0);}catch{}}function qt(a){let i=a.getBoundingClientRect();return {top:i.top,right:i.right,bottom:i.bottom,left:i.left,width:i.width,height:i.height,x:i.x,y:i.y}}function Nt(a,i,e){let{top:t,bottom:n,left:o,right:r}=a;return e>=t&&e<=n&&i>=o&&i<=r}function Da(a,i){let e=i.left<a.left,t=i.left+i.width>a.right,n=i.top<a.top,o=i.top+i.height>a.bottom;return e||t||n||o}function Be(a,i,e){a.top+=i,a.bottom=a.top+a.height,a.left+=e,a.right=a.left+a.width;}function Ln(a,i,e,t){let{top:n,right:o,bottom:r,left:l,width:p,height:_}=a,b=p*i,M=_*i;return t>n-M&&t<r+M&&e>l-b&&e<o+b}var gt=class{_document;positions=new Map;constructor(i){this._document=i;}clear(){this.positions.clear();}cache(i){this.clear(),this.positions.set(this._document,{scrollPosition:this.getViewportScrollPosition()}),i.forEach(e=>{this.positions.set(e,{scrollPosition:{top:e.scrollTop,left:e.scrollLeft},clientRect:qt(e)});});}handleScroll(i){let e=ht(i),t=this.positions.get(e);if(!t)return null;let n=t.scrollPosition,o,r;if(e===this._document){let _=this.getViewportScrollPosition();o=_.top,r=_.left;}else o=e.scrollTop,r=e.scrollLeft;let l=n.top-o,p=n.left-r;return this.positions.forEach((_,b)=>{_.clientRect&&e!==b&&e.contains(b)&&Be(_.clientRect,l,p);}),n.top=o,n.left=r,{top:l,left:p}}getViewportScrollPosition(){return {top:window.scrollY,left:window.scrollX}}};function Zn(a,i){let e=a.rootNodes;if(e.length===1&&e[0].nodeType===i.ELEMENT_NODE)return e[0];let t=i.createElement("div");return e.forEach(n=>t.appendChild(n)),t}function jt(a,i,e){for(let t in i)if(i.hasOwnProperty(t)){let n=i[t];n?a.setProperty(t,n,e?.has(t)?"important":""):a.removeProperty(t);}return a}function we(a,i){let e=i?"":"none";jt(a.style,{"touch-action":i?"":"none","-webkit-user-drag":i?"":"none","-webkit-tap-highlight-color":i?"":"transparent","user-select":e,"-ms-user-select":e,"-webkit-user-select":e,"-moz-user-select":e});}function Vn(a,i,e){jt(a.style,{position:i?"":"fixed",top:i?"":"0",opacity:i?"":"0",left:i?"":"-999em"},e);}function _t(a,i){return i&&i!="none"?a+" "+i:a}function zn(a,i){a.style.width=`${i.width}px`,a.style.height=`${i.height}px`,a.style.transform=Ne(i.left,i.top);}function Ne(a,i){return `translate3d(${Math.round(a)}px, ${Math.round(i)}px, 0)`}var Fe={capture:true},Ft={passive:false,capture:true},Pa=(()=>{class a{static \u0275fac=function(t){return new(t||a)};static \u0275cmp=Kt$1({type:a,selectors:[["ng-component"]],hostAttrs:["cdk-drag-resets-container",""],decls:0,vars:0,template:function(t,n){},styles:[`@layer cdk-resets {
  .cdk-drag-preview {
    background: none;
    border: none;
    padding: 0;
